...
- [API](#api)
- [Let's start with an example](#lets-letsstart-with-an-example)
- [Create an Injector](#create-an-injector)
- [.mappings( mappingObject )](#map-mappingobject-)
- [Map a module knowing the putath](#map-a-module-knowing-the-path)
...
- [.getInstanceOf( mappingName )](#getinstanceof-mappingNameingname-)
- [.getClassOf( mappingName )](#getclassof-mappingname-)
-       [.unmap( mappingName )](#unmap-mappingname-)
- [Fluent API](#fluent-apii)
